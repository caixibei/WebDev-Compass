...
<div style="border: 1px solid rgba(255, 165, 0,.1);
    ...
    <span style="line-height: 16px;">Spring Cloud 2020 版本以后，默认移除了对 Netflix 的依赖，其中就包括 Ribbon，官方默认推荐使用 Spring Cloud Loadbalancer 正式替换 Ribbon，并成为了Spring Cloud 负载均衡器的唯一实现。</span>
</div>
