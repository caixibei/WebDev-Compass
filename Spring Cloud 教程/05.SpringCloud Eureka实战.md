...
> ✨ 也许在多年后我们后知后觉的发现，我们要做的并不是质问对方：为何离开？而是时过境迁之后明白了，每一个未来都有人在，不要执拗的把自己困在回不去的回忆里不断怀念。有时候我们不得不承认，失去并拥有更加踏实。

最近一段时间内，内心总是溢出 “ 要静下心来，好好做一件能够对自己未来3到5年内产生影响的事情 ” 的想法。人呐，在闲的蛋疼的时候总爱胡思乱想，好像又有很久没更新了，那就心血来潮的写一个吧。下面我手把手的教你如何一键部署高可用注册中心服务。👇
...
> 你可以选择直接使用 IDEA 去创建项目骨架，甚至你使用 Eclipse 搭建都行，但我都不用。
...
![image-20241226153343989](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226153343989.png)

点击获取代码之后，将代码下载下来，最终我们的项目结构应该如下所示：

![image-20241226160248870](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226160248870.png)

## 3 项目托管

我们选择将代码托管到 “全球最大的同性交友网站” ，创建仓库，具体如下：

![image-20241226154149306](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226154149306.png)
...
![image-20241226155105010](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226155105010.png)

将 `rsa.pub` 中的密钥复制到剪贴板中（备用），然后打开 Github，进入设置 （Settings）中，如下所示（我开了翻译插件）：

![image-20241226154457244](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226154457244.png)

然后将公钥粘贴进新建的 SSH密钥里面，如下图所示：

![image-20241226155533514](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226155533514.png)
...
![image-20241226155857493](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226155857493.png)
...
![image-20241226161616345](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226161616345.png)

填写完服务器信息之后，点击测试连接，具体如下：

![image-20241226161718325](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226161718325.png)

接下来需要配置连接Docker守护进程`（File->Settings->搜索docker）`来操作Docker，具体如下所示：

![image-20241226161857209](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226161857209.png)

然后我们就需要配置远程部署环境了，具体操作示意图如下：

![image-20241226162003510](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226162003510.png)

新建配置，因为我要部署2个注册中心，所以我配置两个，这样后续就不需要修改参数。

![image-20241226162139252](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226162139252.png)

配置部署参数，这个在上面的上下文配置中找对应的 键名：

![image-20241226162619143](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226162619143.png)
...
![image-20241226162537984](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226162537984.png)

然后点击 部署 运行即可：

![image-20241226162926540](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226162926540.png)

在控制台也能看到运行的日志，十分方便：

![image-20241226163019826](05.SpringCloud%20Eureka%E5%AE%9E%E6%88%98.assets/image-20241226163019826.png)